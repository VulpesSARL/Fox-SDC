...
namespace FoxSDC_Agent.Redirs
{
...
#if DEBUG
        [OperationContract]
        PushScreenData GetDeltaScreenDebug();
#endif
    }
...
#if DEBUG
        public PushScreenData GetDeltaScreenDebug()
        {
            return (Channel.GetDeltaScreenDebug());
        }
#endif
    }
    ...
    /// </summary>
    public class PipeScreenData : IPipeScreenData
    {
        ...
        public delegate CPPFrameBufferData GetFrameBufferDataDG();

        public PushScreenData GetDeltaScreen()
        {
            return (GetDeltaScreen(ProgramAgent.CPP.GetFrameBufferData));
        }

#if DEBUG

        public const string Framebufferpath = "C:\\Temp\\New folder\\";
        ...
        {
            if (FileList.Count == 0)
                FileList = Directory.EnumerateFiles(PipeScreenData.Framebufferpath, "*.png", SearchOption.TopDirectoryOnly).ToList();
            return (GetDeltaScreen(GetFrame));
        }
