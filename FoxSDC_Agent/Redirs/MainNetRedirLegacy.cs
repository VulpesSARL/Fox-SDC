...
namespace FoxSDC_Agent.Redirs
{
    class NetRedirLegacy
    {
        ...
        public NetRedirLegacy(string ToServer, int Port, string SessionID, Network net)
        {
            this.net = net;
    ...
    class MainNetRedirLegacy
    {
        static object Locker = new object();
        static Dictionary<string, NetRedirLegacy> Redirs = new Dictionary<string, NetRedirLegacy>();
        ...
        public static void TestTimeouts()
        {
            ...
            lock (Locker)
            {
                foreach (KeyValuePair<string, NetRedirLegacy> pp in Redirs)
                {
